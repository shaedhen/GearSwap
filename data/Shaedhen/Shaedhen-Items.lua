...
--Augmented items that you'll use among multiple jobs.
	...
	-- Ayanmo	
	gear.Ayanmo_Head	= { name="Ayanmo Zucchetto +2"}
	gear.Ayanmo_Body	= { name="Ayanmo Corazza +2"}
	gear.Ayanmo_Hands	= { name="Ayanmo Manopolas +2"}
	gear.Ayanmo_Legs	= { name="Ayanmo Cosciales +2"}
	gear.Ayanmo_Feet	= { name="Ayanmo Gambieras +2"}
	
	-- Jhakri	
	gear.Jhakri_Head	= { name="Jhakri Coronal +2"}
	gear.Jhakri_Body	= { name="Jhakri Robe +2"}
	gear.Jhakri_Hands	= { name="Jhakri Cuffs +2"}
	gear.Jhakri_Legs	= { name="Jhakri Slops +2"}
	gear.Jhakri_Feet	= { name="Jhakri Pigaches +2"}
	
	-- Meghanada	
	gear.Meghanada_Head		= { name="Meghanada Visor +2"}
	gear.Meghanada_Body		= { name="Meghanada Cuirie +2"}
	gear.Meghanada_Hands	= { name="Meghanada Gloves +2"}
	gear.Meghanada_Legs		= { name="Meghanada Chausses +2"}
	gear.Meghanada_Feet		= { name="Meghanada Jambeaux +2"}
	
	-- Mummu	
	gear.Mummu_Head		= { name="Mummu Bonnet +2"}
	gear.Mummu_Body		= { name="Mummu Jacket +2"}
	gear.Mummu_Hands	= { name="Mummu Wrists +2"}
	gear.Mummu_Legs		= { name="Mummu Kecks +2"}
	gear.Mummu_Feet		= { name="Mummu Gamashes +2"}
	
	-- Sulevia	
	gear.Sulevia_Head	= { name="Sulevia Mask +1"}
	gear.Sulevia_Body	= { name="Sulevia Platemail +1"}
	gear.Sulevia_Hands	= { name="Sulevia Gauntlets +1"}
	gear.Sulevia_Legs	= { name="Sulevia Cuisses +1"}
	gear.Sulevia_Feet	= { name="Sulevia Leggings +1"}
	
	-- Flamma	
	gear.Flamma_Head	= { name="Flamma Zucchetto +1"}
	gear.Flamma_Body	= { name="Flamma Korazin +1"}
	gear.Flamma_Hands	= { name="Flamma Manopolas +1"}
	gear.Flamma_Legs	= { name="Flamma Dirs +1"}
	gear.Flamma_Feet	= { name="Flamma Gambieras +1"}
	
	-- Hizamaru	
	gear.Hizamaru_Head	= { name="Hizamaru Somen +1"}
	gear.Hizamaru_Body	= { name="Hizamaru Haramaki +1"}
	gear.Hizamaru_Hands	= { name="Hizamaru Kote +1"}
	gear.Hizamaru_Legs	= { name="Hizamaru Hizayoroi +1"}
	gear.Hizamaru_Feet	= { name="Hizamaru Sune-Ate +1"}
	
	-- Tali'ah	
	gear.Taliah_Head	= { name="Tali'ah Turban +1"}
	gear.Taliah_Body	= { name="Tali'ah Manteel +1"}
	gear.Taliah_Hands	= { name="Tali'ah Gages +1"}
	gear.Taliah_Legs	= { name="Tali'ah Seraweels +1"}
	gear.Taliah_Feet	= { name="Tali'ah Crackows +1"}
	
	-- Inyanga
	gear.Inyanga_Head	= { name="Inyanga Tiara +2"}
	gear.Inyanga_Body	= { name="Inyanga Jubbah +2"}
	gear.Inyanga_Hands	= { name="Inyanga Dastanas +2"}
	gear.Inyanga_Legs	= { name="Inyanga Shalwar +2"}
	gear.Inyanga_Feet	= { name="Inyanga Crackows +1"}
	
	-- Mallquis
	gear.Mallquis_Head	= { name="Mallquis Chapeau +2"}
	gear.Mallquis_Body	= { name="Mallquis Saio +2"}
	gear.Mallquis_Hands	= { name="Mallquis Cuffs +2"}
	gear.Mallquis_Legs	= { name="Mallquis Trews +2"}
	gear.Mallquis_Feet	= { name="Mallquis Clogs +2"}
    ...
    -- Taeon
	gear.Taeon_Crit_head = {name="Taeon Chapeau", augments={'Accuracy+18 Attack+18','Crit.hit rate+1','Crit. hit damage +3%',}}
	gear.Taeon_WS_body = {name="Taeon Tabard", augments={'Accuracy+19 Attack+19','Weapon Skill Acc.+15','Crit. hit damage +2%',}}
	gear.Taeon_Trip_hands = {name="Taeon Gloves", augments={'Rng.Acc.+15 Rng.Atk.+15','"Triple Atk."+2','"Snapshot"+4',}}
    gear.Taeon_Crit_legs = {name="Taeon Tights", augments={'Accuracy+19 Attack+19','Crit.hit rate+2','STR+7 DEX+7',}}
	gear.Taeon_Trip_feet = {name="Taeon Boots", augments={'Accuracy+17 Attack+17','"Triple Atk."+1','STR+7 AGI+7',}}
	gear.Taeon_PhalWalz_head = {name="Taeon Chapeau", augments={'Rng.Acc.+14 Rng.Atk.+14','"Dual Wield"+5','Phalanx +3',}}
	gear.Taeon_PhalWalz_body = {name="Taeon Tabard", augments={'"Waltz" potency +2%','Phalanx +1',}}
	gear.Taeon_PhalWalz_hands = {name="Taeon Gloves", augments={'"Waltz" potency +4%','Phalanx +2',}}
	gear.Taeon_PhalWalz_legs = {name="Taeon Tights", augments={'"Waltz" potency +3%','Phalanx +3',}}
	...
	gear.Gende_DT_feet = {name="Gende. Galosh. +1", augments={'Phys. dmg. taken -4%','Magic dmg. taken -3%','"Cure" spellcasting time -3%',}}
	
	-- Carmine
	gear.Carmi_D_hands={ name="Carmine Fin. Ga. +1", augments={'Rng.Atk.+20','"Mag.Atk.Bns."+12','"Store TP"+6',}}
	gear.Carmi_D_legs={ name="Carmine Cuisses +1", augments={'Accuracy+20','Attack+12','"Dual Wield"+6',}}
	gear.Carmi_B_feet={ name="Carmine Greaves +1", augments={'Accuracy+12','DEX+12','MND+20',}}
